...
export function FeaturesSectionDemo() {
  return (
    <div className="py-10 lg:py-20">
      {/* Reduced padding to remove space from top and bottom */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-12 max-w-5xl mx-auto">
        {grid.slice(0, 6).map((feature) => (
          <div
            key={feature.title}
            className="relative bg-gradient-to-b dark:from-neutral-900 from-neutral-100 dark:to-neutral-950 to-white p-10 rounded-3xl overflow-hidden"
          >
            <Grid size={20} />

            <div className="absolute top-4 left-4">{feature.icon}</div>

            <p className="text-base font-bold text-neutral-800 dark:text-white relative z-20 mt-12">
              {feature.title}
            </p>
...
const grid = [
  ...
  {
    icon: <PieChartIcon className="h-8 w-8 text-black" />,
